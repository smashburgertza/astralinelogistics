import { Package, PackageSearch, MoveRight, Clock } from 'lucide-react';
...
interface LooseCargoCalculatorProps {
...
export function LooseCargoCalculator({
  regions,
  pricing,
  regionId,
  setRegionId,
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-100">
        ...
        <p className="text-sm text-blue-700">LCL shipping for small to medium shipments</p>
      </div>
          ...
          teaserContent={
            <div className="pt-4 border-t border-border space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Est. Delivery: {deliveryTimes?.sea_cargo || DEFAULT_DELIVERY_TIMES.sea_cargo}</span>
              </div>
            </div>
          }
          fullContent={
